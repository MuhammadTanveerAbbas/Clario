...
const MODES: {
  ...
  },
  {
    ...
    desc: "Extract decisions, owners, and open questions",
    ...
    <>
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .card{background:hsl(var(--card));border:1px solid var(--card-b);border-radius:14px;overflow:hidden}
